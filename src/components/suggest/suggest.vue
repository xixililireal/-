<template>
    ...
    >
      <ul class="suggest-list">
        <li  class="suggest-item" v-for="(item, index) of result" @click="selectItem(item, index)">
          <div class="icon">
  ...
  methods: {
    search() {
      ...
      search(this.query,this.page,this.showSinger,perpage).then((res) => {
        if(res.code === ERR_OK) {
          this.result = this._gerResult(res.data)
    ...
    searchMore() {
      ...
      search(this.query,this.page,this.showSinger,perpage).then((res) => {
        if(res.code === ERR_OK) {
          this.result = this.result.concat(this._gerResult(res.data))
          this._checkMore(res.data)
        }
      })
    },
